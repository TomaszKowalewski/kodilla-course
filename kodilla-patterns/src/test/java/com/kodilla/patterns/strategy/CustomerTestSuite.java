...
public class CustomerTestSuite {
    ...
    void testIndividual() {
        ...
        //When
        String stevenShouldToBuy = steven.predict();
        System.out.println("Steven should: " + stevenShouldToBuy);
        steven.setBuyingStrategy(new AggressivePredictor());
        stevenShouldToBuy = steven.predict();
        System.out.println("Steven now should: " + stevenShouldToBuy);

        //Then
        assertEquals("[Aggressive predictor] Buy stock of XYZ", stevenShouldToBuy);
    }
